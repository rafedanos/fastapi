...
#for getting the amount of votes that each post has, uses sql joins from sqlalchemy
...
@router.post("/", status_code=status.HTTP_201_CREATED, response_model=schemas.Post)                                         #posts allow you to send data as well as recieve 
